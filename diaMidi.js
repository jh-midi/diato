...
window.addEventListener("keydown", function(event) {
	...
	break;
	case 'Digit1': tune_fn_key(-1);document.title="Irish BC";
	break;
	case 'Digit2': tune_fn_key(0);document.title="Irlandais CC#";
	break;
    ...
    break;
    case 'Digit8': {fill_cgriff(TUNE_REF,0), css_notes();document.title="C griff chromatique français"}
    break;
